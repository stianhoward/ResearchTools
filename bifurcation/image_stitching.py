...
front_image_path = '/media/stian/Evan Dutch/Bifurcation/12805/front/2848/2848_'
back_image_path = '/media/stian/Evan Dutch/Bifurcation/12805/back/2851/2851_'
...
for i in range(image_count):
    ...
    result.save('/media/stian/Evan Dutch/Bifurcation/12805/stitched/285/' + num + '.bmp')
